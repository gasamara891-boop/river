    ...
    <section className="md:pt-48 sm:pt-28 pt-12" id="portfolio">
      <div className="container mx-auto lg:max-w-screen-xl px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 items-center gap-20">
          ...
          >
            <Image
              src={`${getImagePrefix()}images/portfolio/protect-wealth-adf44c600d6af6c71b56c1858dd27f7d24ad.webp`}
          ...
          >
            ...
            <h2 className="text-white sm:text-40 text-30 mb-4 font-medium">
              Create your crypto portfolio today with River
              <span className="text-primary">Tech</span>!
            </h2>
            <p className="text-muted text-opacity-60 text-18">
              River has a variety of features that make it the best
