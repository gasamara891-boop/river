        ...
        <div ref={ref} className="grid grid-cols-12 items-center">
          ...
          >
            <p className="sm:text-28 text-18 text-white">
              Exploring <span className="text-primary">River Technology</span>
            </p>
            <h2 className="sm:text-40 text-30 text-white lg:w-full md:w-70% font-medium">
              Smart, Secure, and Built for the Future

Shaping the Next Era of Decentralized Platforms
            </h2>
          ...
          <motion.div {...TopAnimation} className="lg:col-span-5 col-span-12">
            <div className="2xl:-mr-40 mt-9 flex justify-center">
              <Image
                src= {`${getImagePrefix()}images/work/public-financials-mobile-d0ffbaade623e87c131d048ece55fefb24ad.webp`}
                alt="image"
                width={600}
                height={425}
                className="lg:w-full"
